export const Bio = {
  ...
  description:
    "As Thrinley Karma Dorji, a front-end web developer, my passion lies in crafting captivating user experiences through innovative design and seamless functionality. With a keen eye for detail and a commitment to staying abreast of the latest industry trends, I strive to create dynamic websites that not only meet but exceed client expectations. Through collaboration and dedication, I aim to bring visions to life and elevate online presence for businesses and individuals alike.",
  github: "https://github.com/ThrinleyKarmaDorji",
  resume:"https://drive.google.com/file/d/1No2HMwdZCR0_O6sp_Riuu4FcvjGhYc7X/view?usp=drive_link",
...
export const experiences = [
  {
    ...
    role: "HTML",
    company: "Lernio Academy | DSP Skilling Program",
    date: "June 2019 - Present",
    desc: "Enhanced user experiences on Lernio acdemy , Portals by resolving bugs & reduced load time by 40%. Using an HTML i have created an simple structure with seamless interaction with the user.",
    skills: [
      "ReactJS",
      "Redux",
      "NodeJs",
  ...
  },
  {
    ...
    role: "CSS",
    company: "Lernio Academy | DSP Dessup Skilling Program",
    date: "Aug 2023 - Oct 2024",
    desc: "With this CSS we use to style our web sites and make more and user interactive and make more user Interface and give more user attrection.",
    skills: [
      "JavaScript",
      "TypeScript",
      "Node Js",
  ...
  },
  {
    ...
    role: "JAVA SSCRIPT",
    company: "Lernio Acdemy | DSP Dessup skilling Program ",
    date: "June 2021 - Oct 2021",
    desc: "• With the Java Script we make our Website more useable using this Language we can do our Back-end with this",
    skills: [
      "Java",
      "Kotlin",
      "XML",
...

  {
    ...
    company: "DSP Desuup Skilling | Lernio Academy",
    date: "Nov2021 - Present",
    desc: "As an Web developer at the Lernio Academy, I have had the opportunity to work on exciting projects and collaborate with talented developers who share my passion for technology. I have also had the opportunity to host and participate in numerous events.",
    skills: [
      "Leadership",
  ...
  {
    id: 5,
    img: "https://miro.medium.com/v2/resize:fit:1358/1*MF5V_dkybUTcfzwHFh0VSw.jpeg",
    role: "React Js",
    company: "DSP Skilling Program | Lernio Academy",
    date: "May 2023 - Present",
    desc: "i have trained from the DSP and Lernio interms of this react during this cource i have completed many projects using and react.",
  },
];
...
export const education = [
  {
    id: 0,
    school: "DSP Skilling Program",
    date: "June 2023 -  July 2023",
    grade: "A++",
    desc: "I am currently pursue in the IT Knowledge During that year of learning i have gone through Internal Parts of the computer and external and learn Excel, Ms, Power Point and Net Working ",
    Qualification: "Knowledge in the Excel, Ms, and Power Point",
  },
  {
    id: 1,
    school: "DSP Skilling Program",
    ...
    grade: "A++",
    desc: "I completed This course i have gone through the HTML, CSS, and Java script and created many Project using this this language.",
    Qualification: "Knoweldege in the HTML, CSS and Java Script",
  },
  {
    id: 2,
    school: "DSP Skilling Program",
    ...
    grade: "A++",
    desc: "I have completed this third cource in the DSP skilling Program collaboration with Lernio Academy and Enhace my Knowledege in HTML, CSS,Java Script and React",
    Qualification: "Knoweldege in the HTML, CSS, Java Script and React Js",
  },
];
